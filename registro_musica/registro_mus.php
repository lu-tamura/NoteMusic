...
<head>
    ...
    <link rel="stylesheet" href="registro_mus_styles.css">
...
<body>
    ...
    <main class="conteudo">
        <div class="informacoes">
            <h1 class="conteudo-titulo">Informações</h1>
        
            <form action="processar_registro.php" method="post" >
                <input type="text" name="musica" placeholder="Digite o nome da música" required><br>
                <input type="text" name="album" placeholder="Digite o nome do álbum" required><br>
                <input type="text" name="artista" placeholder="Digite o nome do artista" required><br>
                <input type="text" name="capa" placeholder="Insira o link da capa" required><br>
